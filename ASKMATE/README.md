...
2. As a registered user, I'd like to be able to login to the system with my previously saved username and password.
...
3. There should be a page where I can list all the registered users with all their attributes.
